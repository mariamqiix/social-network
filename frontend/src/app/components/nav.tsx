...
export default function Nav() {
    ...
    return <nav className="h-100 overflow-y-scroll">
        <ul className="nav flex-column p-5">
            <div className="container-fluid d-flex flex-column align-items-center">
                <a className="navbar-brand m-0 p-0" href="#">
                    <Image className="rounded-circle" src="/placeholder.jpg" width={80} height={80} alt="Avatar" />
                </a>
                <br />
                Hasan kadhem
                <br />
            ...
            {links.map((link, i) =>
                <Link href={link} key={link} className={(pathName == link ? "btn-dark" : "") + " btn nav-item rounded-4 m-1 d-flex align-items-center"}>
